 ...
 */
export function doctorFolder(doctorName: string, doctorId?: string): string {
 ...
 */
export function originalPdfKey(doctorName: string, doctorId: string | undefined, bookSlug: string): string {
  return `store-items/by-doctor/${doctorFolder(doctorName, doctorId)}/ebooks/originals/${bookSlug}/${bookSlug}.pdf`;
}
 ...
 */
export function watermarkedPdfKey(doctorName: string, doctorId: string | undefined, orderRef: string, slug: string): string {
  return `store-items/by-doctor/${doctorFolder(doctorName, doctorId)}/ebooks/orders/${orderRef}/${slug}-watermarked.pdf`;
}
