...
/* Features data lives here so no icons (functions) need to be serialised
   across the Server → Client boundary. */
const features = [
  {
    Icon: Stethoscope,
    title: "Consultation workspace",
    body: "Structured homeopathic case-taking for OPD and online — same file, same flow, every time. AI notetaker assists without interrupting.",
  ...
  },
  {
    ...
    body: "Your patients get a clinic app under your practice. Medicine reminders, diet and lifestyle guidance, doctor-assigned todos, and follow-up tracking — all personalised to your prescription.",
  ...
  },
  {
    Icon: Sparkles,
    title: "AI notetaker",
    body: "Records and structures clinical notes during your consultation. Every word is yours to review, edit, and approve before anything is saved.",
  ...
  },
  {
    ...
    body: "Print-ready PDFs with your name, registration, clinic details, and digital signature — sent directly to the patient. Doctor and patient versions, always aligned.",
  ...
  },
  {
    ...
    body: "Track your remedy and supplement stock, build treatment kits for common case types, and get alerts before you run out of what you need.",
  ...
  },
  {
    ...
    body: "Tools to build your clinic's presence — a professional online identity, patient referrals, and communication under your clinic brand, not your personal accounts.",
